...
public abstract class Renderer {
    ...
    public void draw(Mesh mesh, @Nullable Shader shader, Vector3f pos, Quaternionf rotation) {
        draw(mesh, shader, pos, rotation, 1f);
    }
    public void draw(Mesh mesh, @Nullable Shader shader, Vector3f pos, Quaternionf rotation, float scale) {
